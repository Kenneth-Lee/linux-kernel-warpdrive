...
static int dummy_wd2_probe(struct platform_device *pdev) {
	...
	dev_set_name(&hw->dummy_wd2_dev, "dummy_wd2-%d", 0); //assume I have only one device now
...
static const struct of_device_id wd_dummy_of_match[] = {
	{.compatible = "warpdrive,wd_dummy_v2",},
	{},
};
...
static struct platform_driver dummy_wd2_pdrv = {
	...
	.driver		= {
		.name		= DUMMY2_WD,
		.of_match_table = wd_dummy_of_match,
	},
};
